namespace Quantum.Kata.BoundedKnapsack
{
	...
	// of more than P, while not exceeding a maximum weight W.
	...
	// xᵢ represents the number of instances of index i that are put into the knapsack, so 0 ≤ xᵢ ≤ bᵢ for all i.
	// Thus, we seek a combination xs = [x₀, x₁, ..., xₙ₋₁] that satisfies the bounds,
	// has total weight at most W, and has total profit more than P.
