...
namespace Quantum.Kata.MagicSquareGame {
    ...
    // Inputs:
    //     1) The row and column indices Alice and Bob were assigned from 0 to 2,
    ...
    // Input:  The index of Bob's row.
    // Output: The signs Bob should place in his row (as an Int array of length 3).
    //         +1 indicates plus sign, -1 - minus sign.
    ...
    function MagicSquareObservable (row : Int, column : Int) : (Qubit[] => Unit is Adj+Ctl) {
