...
\newbox\matrixrepresentationleft
\sbox\matrixrepresentationleft{\parbox{\textwidth}{
  \footnotesize
  N X M Matrix
}}
...
\sbox\matrixrepresentationright{\parbox{\textwidth}{
  \footnotesize
  $\qquad \underrightarrow{\text{n columns}} $\\
  $\rotatebox[origin=c]{270}{\underrightarrow{\text{m rows}}}$    
  $\begin{bmatrix} 
...
\newbox\vectorrepresentationleft
\sbox\vectorrepresentationleft{\parbox{\textwidth}{
  \footnotesize
  Vector of size N
}}

\newbox\vectorrepresentationright
\sbox\vectorrepresentationright{\parbox{\textwidth}{
  \footnotesize
  $\begin{bmatrix}
    a_1 & a_2 & a_3
  \end{bmatrix}$ 
...
\begin{multicols}{3}
  ...
  \begin{keysref}{Complex Arithmetic}
    ...
    Polar form \newline $ re^{i\theta} $ &  Cartesian form \newline $  r(\cos(\theta) + i\sin(\theta)) \newline a +bi $ \\
    Cartesian form \newline $ a + bi $ & Polar form \newline $ re^{i\theta} \newline r =  \sqrt{a^2 + b^2}  \newline  \theta = \arctan(\frac{b}{a}) $ \\
  \end{keysref}
  ...
  \begin{keysref}{Linear Algebra}
    ...
    \usebox\matrixrepresentationleft & \usebox\matrixrepresentationright \\

    \usebox\vectorrepresentationleft & \usebox\vectorrepresentationright \\
  ...
  \begin{keysrefGates}{Single Qubit gates}
    ...
    $ R_x(\theta) $ & 
    \usebox\rxgate & 
    $ \cos\frac{\theta}{2}\ket{0}\bra{0}  -i\sin\frac{\theta}{2}\ket{1}\bra{0}  \newline -i\sin\frac{\theta}{2}\ket{0} \bra{1} + \cos\frac{\theta}{2}\ket{1}\bra{1} $ & 
    ...
    $ R_y(\theta) $ & 
    \usebox\rygate   & 
    $\cos\frac{\theta}{2}\ket{0}\bra{0} + \sin\frac{\theta}{2} \ket{1}\bra{0} \newline  -\sin\frac{\theta}{2}\ket{0}\bra{1} + \cos\frac{\theta}{2}\ket{1}\bra{1}$ & 
