...
% Work arround for not correctly rendering brackets https://tex.stackexchange.com/questions/520847/left-matrix-bracket-not-rendered-properly
...
\begin{multicols}{3}
  ...
  \end{keysref}
	...
	\( (a + bi)  (c + di) \) & \( a \cdot b + a \cdot di + c \cdot bi + (b \cdot d)i^2 \) \newline
		\(  a \cdot b + a \cdot di + c \cdot bi - (b \cdot d) \) \\
