...
RUN dotnet build GraphColoring
RUN jupyter nbconvert GraphColoring/GraphColoring.ipynb --execute --stdout --to markdown  --allow-errors  --ExecutePreprocessor.timeout=120
