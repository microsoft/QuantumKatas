...
```bash
   $ ./scripts/validate-notebooks.ps1 ./BasicGates/BasicGates.ipynb
```
...
and to [have PowerShell installed](https://docs.microsoft.com/powershell/scripting/install/installing-windows-powershell).
